export default {
    ...
    state: {
        ...
        review: {
            as     : ['Student'],
            rating : 5,
            content: 'A great and supportive educator who transformed "Hello World" students into wizards of full-fledged applications, a friend, a skilled programmer with a limitless charge of curiosity, a team leader, and also one of the most important elements in my own periodic table.'
        },
        // ===================================================================================================
        ...
        socials: {
            github  : 'https://github.com/frozeeen',
            twitter : '',
            facebook: 'https://facebook.com/florencio.bagayawa'
        }
        // ===================================================================================================
